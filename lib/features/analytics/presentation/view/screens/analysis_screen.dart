...
class _AnalysisScreenState extends State<AnalysisScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (state is AnalyticsLoading)
                        ...
                        _buildDonutChart(context, state),
                        const SizedBox(height: 24),
  ...
  Widget _buildDonutChart(BuildContext context, AnalyticsLoaded analytics) {
  ...
  Widget _buildSpendingTrend(BuildContext context, AnalyticsLoaded analytics) {
    final categorySpending = analytics.categorySpending;
  ...
  Widget _buildSummaryCards(BuildContext context, AnalyticsLoaded analytics) {
    return Column(
      children: [
        Row(
          children: [
